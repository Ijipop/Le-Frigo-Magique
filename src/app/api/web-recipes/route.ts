...
export const GET = withRateLimit(
  ...
  async (req: Request) => {
    ...
    const filterTerms: { [key: string]: string } = {
      ...
      "japonais": "japonais japanese cuisine japonaise sushi ramen teriyaki",
      "mexicain": "mexicain mexican cuisine mexicaine tacos burrito enchilada",
      "indien": "indien indian cuisine indienne curry tikka masala",
      "italien": "italien italian cuisine italienne pasta risotto",
      "chinois": "chinois chinese cuisine chinoise stir-fry wok",
      "thailandais": "thaïlandais thai cuisine thailandaise pad thai curry",
      "mediterraneen": "méditerranéen mediterranean cuisine mediterraneenne grecque",
      "marocain": "marocain moroccan cuisine marocaine tagine couscous",
