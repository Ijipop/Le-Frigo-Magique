  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-rose-50">
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              ...
              <Link
                href="#features"
                className="rounded-full border-2 border-gray-300 px-8 py-4 text-lg font-semibold text-gray-700 transition-all hover:border-orange-500 hover:text-orange-500"
              >
                En savoir plus
              </Link>
            </div>
        ...
        {/* Decorative elements */}
        <div className="absolute -top-24 -right-24 h-96 w-96 rounded-full bg-orange-200 opacity-30 blur-3xl" />
        <div className="absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-rose-200 opacity-30 blur-3xl" />
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="text-center">
              ...
              <div className="mt-2 text-lg text-gray-600">d'économies en moyenne</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-rose-500">0</div>
              <div className="mt-2 text-lg text-gray-600">gaspillage alimentaire</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-amber-500">100%</div>
              <div className="mt-2 text-lg text-gray-600">personnalisé selon vos goûts</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3">
            {/* Feature 1 */}
            <div className="group rounded-2xl bg-white p-8 shadow-lg transition-all hover:scale-105 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Planification intelligente</h3>
            ...
            <div className="group rounded-2xl bg-white p-8 shadow-lg transition-all hover:scale-105 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Gestion du budget</h3>
              <p className="mt-3 text-gray-600">
            ...
            <div className="group rounded-2xl bg-white p-8 shadow-lg transition-all hover:scale-105 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Garde-manger virtuel</h3>
              <p className="mt-3 text-gray-600">
            ...
            <div className="group rounded-2xl bg-white p-8 shadow-lg transition-all hover:scale-105 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Listes d'épicerie automatiques</h3>
              <p className="mt-3 text-gray-600">
            ...
            <div className="group rounded-2xl bg-white p-8 shadow-lg transition-all hover:scale-105 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Recettes personnalisées</h3>
              <p className="mt-3 text-gray-600">
            ...
            <div className="group rounded-2xl bg-white p-8 shadow-lg transition-all hover:scale-105 hover:shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Rapide et intuitif</h3>
              <p className="mt-3 text-gray-600">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-orange-500 via-rose-500 to-amber-500 py-20">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-white sm:text-5xl">
            Prêt à transformer votre façon de manger ?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-xl text-orange-50">
      ...
      <footer className="bg-gray-900 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-400">Votre assistant intelligent pour la planification de repas</p>
