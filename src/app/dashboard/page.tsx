    ...
    <main className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-rose-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-6 max-md:px-4 max-sm:px-3 py-10 max-md:py-6 max-sm:py-4">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 max-md:mb-6 max-sm:mb-4">
          <div className="flex items-center gap-4 mb-4 max-md:gap-2">
            <Image
              src="/logo.png"
              alt="FrigoPop"
              width={48}
              height={48}
              className="h-12 w-auto max-md:h-8 rounded-lg"
            />
            <h1 className="text-4xl max-md:text-2xl max-sm:text-xl font-bold bg-gradient-to-r from-orange-500 via-rose-500 to-amber-500 bg-clip-text text-transparent">
              Bienvenue {userName} dans votre FrigoPop !
            </h1>
          </div>
